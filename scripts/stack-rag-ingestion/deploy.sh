...
# Script: Deploy RAG Ingestion Infrastructure
# Description: Deploys CDK infrastructure for RAG ingestion Lambda
...
main() {
    log_info "Deploying RAG Ingestion Stack..."
    ...
    recover_delete_failed_stack "${CDK_PROJECT_PREFIX}-RagIngestionStack"
